...
const DropDown = forwardRef((props, ref) => {
    ...
    return (<Menu visible={visible} onDismiss={onDismiss} theme={theme} anchor={<TouchableOpacity ref={ref} onPress={showDropDown} onLayout={onLayout} accessibilityLabel={accessibilityLabel}>
